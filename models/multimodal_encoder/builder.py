...
def build_vision_encoder(mm_vision_tower: str, args):
    ...
    elif "c-radio" in mm_vision_tower.lower():
        from .c_radio_encoder import CRadioVisionTower
        vision_encoder = CRadioVisionTower(mm_vision_tower, args, delay_load=True)
